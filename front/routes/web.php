...
use Travalorics\Front\Controllers;
use Travalorics\Front\Controllers\Account;
...
Route::post('/front/reviews/{id}/helpful', [Controllers\ProductController::class, 'helpful'])->name('reviews.helpful');
...
Route::post('/checkout/coupon', [Controllers\CheckoutController::class, 'applyCoupon'])->name('checkout.coupon');
...
Route::post('/register/verify', [Account\RegisterController::class, 'verifyOtp'])->name('register.verify');
...
Route::post('/forgotten/check_code', [Account\ForgottenController::class, 'checkVerifyCode'])->name('forgotten.check_code');
...
Route::get('/preview-success', function() { return view('front::payment.success', ['order' => \Travalorics\Common\Models\Order::latest()->first()]); });
