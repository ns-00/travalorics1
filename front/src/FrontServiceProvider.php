...
use Travalorics\Common\Middleware\ContentFilterHook;
use Travalorics\Common\Middleware\EventActionHook;
use Travalorics\Common\Models\Customer;
use Travalorics\Front\Middleware\CustomerAuthentication;
use Travalorics\Front\Middleware\GlobalFrontData;
use Travalorics\Front\Middleware\MaintenanceMode;
use Travalorics\Front\Middleware\SetFrontLocale;
...
class FrontServiceProvider extends ServiceProvider
{
     ...
     * php artisan vendor:publish --provider='Travalorics\Front\FrontServiceProvider' --tag=views
     *
     * @return void
     */
