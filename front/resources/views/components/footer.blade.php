          ...
          <div class="col-12 col-md-4 footer-item">
            <div class="about">
              ...
              <div class="about-text footer-item-content">
                ...
                <div class="social-links mt-4 d-flex gap-4">
                  <a href="https://www.facebook.com/travaloricfe" target="_blank" class="text-secondary fs-2" aria-label="Facebook"><i class="bi bi-facebook"></i></a>
                  <a href="https://www.instagram.com/travaloricfe" target="_blank" class="text-secondary fs-2" aria-label="Instagram"><i class="bi bi-instagram"></i></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="left-links">
              ...
              <!-- Powered By Travalorics {{ Travalorics_version() }} -->
