...
@section('title', \Travalorics\Common\Libraries\MetaInfo::getInstance($page)->getTitle())
@section('description', \Travalorics\Common\Libraries\MetaInfo::getInstance($page)->getDescription())
@section('keywords', \Travalorics\Common\Libraries\MetaInfo::getInstance($page)->getKeywords())
