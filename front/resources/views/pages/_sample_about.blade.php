        ...
        <div class="col-12 col-lg-4">
          <div class="contact-item" data-aos="fade-up" data-aos-duration="2000">
            ...
            <div class="right">
              ...
              <div class="text-2"><i class="bi bi-envelope-fill text-primary"></i> team@Travalorics.com</div>
            </div>
          </div>
        </div>
        <div class="col-12 col-lg-4">
          <div class="contact-item" data-aos="fade-up" data-aos-duration="2000">
            ...
            <div class="right">
              ...
              <div class="text-2"><i class="bi bi-wechat text-primary"></i> Travalorics666</div>
            </div>
          </div>
        </div>
      </div>
