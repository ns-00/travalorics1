...
@section('title', \Travalorics\Common\Libraries\MetaInfo::getInstance($brand)->getTitle())
@section('description', \Travalorics\Common\Libraries\MetaInfo::getInstance($brand)->getDescription())
@section('keywords', \Travalorics\Common\Libraries\MetaInfo::getInstance($brand)->getKeywords())
