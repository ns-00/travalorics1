...
use Travalorics\Panel\Controllers;
...
Route::middleware(['admin_auth:admin'])
    ->group(function () {
        ...
        Route::put('/reviews/{review}/feature', [Controllers\ReviewController::class, 'feature'])->name('reviews.feature');
        Route::put('/reviews/{review}/status', [Controllers\ReviewController::class, 'updateStatus'])->name('reviews.status');
        ...
        Route::get('/reports/print', [Controllers\ReportController::class, 'print'])->name('reports.print');
        ...
        Route::get('/file_manager', [Travalorics\RestAPI\PanelApiControllers\FileManagerController::class, 'index'])->name('file_manager.index');
        Route::get('/file_manager/iframe', [Travalorics\RestAPI\PanelApiControllers\FileManagerController::class, 'iframe'])->name('file_manager.iframe');
    });
