...
use Travalorics\Panel\Repositories\LocaleRepo;
...
if (! function_exists('panel_locale_direction')) {
    ...
    function panel_locale_direction(): string
    {
        ...
        $rtlCodes   = array_keys(\Travalorics\Common\Repositories\LocaleRepo::getRtlLanguages());
...
if (! function_exists('dashboard_url')) {
    /**
     * Get dashboard url
     * like https://www.Travalorics.com/install/dashboard.jpg?edition=community&version=1.0.0&build_date=20250909
     *
     * @return string
     */
    function dashboard_url(): string
    {
        $params = [
            ...
            'edition'    => config('Travalorics.edition'),
            'version'    => config('Travalorics.version'),
            'build_date' => config('Travalorics.build'),
        ];
        $urlParams = http_build_query($params);

        return config('Travalorics.api_url').'/install/dashboard.jpg?'.$urlParams;
    }
}
