...
use Travalorics\Panel\Console\Commands\ChangeRootPassword;
use Travalorics\Panel\Middleware\AdminAuthenticate;
use Travalorics\Panel\Middleware\GlobalPanelData;
...
class PanelServiceProvider extends ServiceProvider
{
    ...
    {
        $originViewPath = travalorics_path('panel/resources/views');
