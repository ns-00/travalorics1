...
use Travalorics\Panel\Requests\LocaleRequest;
use Travalorics\Panel\Services\TranslationService;
...
class LocaleController extends BaseController
{
    ...
    public function index(): mixed
    {
        ...
        return travalorics_view('panel::locales.index', $data);
    }
    ...
    public function edit(Locale $locale): mixed
    {
        ...
        return travalorics_view('panel::locales.form', $data);
    }
    ...
    {
        try {
            $item = LocaleRepo::getHardcodedLocales()->where('id', $id)->first();
            if (! $item) {
            ...
            // Mocking saving by doing nothing for now
