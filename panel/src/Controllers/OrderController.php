...
class OrderController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return travalorics_view('panel::orders.index', $data);
    }
    ...
    {
        $order->load(['items.options', 'fees', 'payments', 'histories']);
    ...
    public function form(Order $order): mixed
    {
        ...
        return travalorics_view('panel::orders.detail', $data);
    }
    ...
    public function printing(Order $order): mixed
    {
        ...
        return travalorics_view('panel::orders.printing', $data);
    }
