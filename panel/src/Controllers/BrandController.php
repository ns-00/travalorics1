...
use Travalorics\Common\Models\Brand;
use Travalorics\Common\Repositories\BrandRepo;
use Travalorics\Panel\Requests\BrandRequest;
...
class BrandController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return travalorics_view('panel::brands.index', $data);
    }
    ...
    public function form($brand): mixed
    {
        ...
        return travalorics_view('panel::brands.form', $data);
    }
