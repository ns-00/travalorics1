...
use Travalorics\Common\Models\WeightClass;
use Travalorics\Common\Repositories\WeightClassRepo;
use Travalorics\Panel\Requests\WeightClassRequest;
...
class WeightClassController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return travalorics_view('panel::weight_classes.index', compact('weightClasses'));
    }
    ...
    {
        return travalorics_view('panel::weight_classes.form', compact('weight_class'));
    }
}
