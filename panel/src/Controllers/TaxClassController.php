...
use Throwable;
use Travalorics\Common\Models\TaxClass;
...
use Travalorics\Panel\Requests\TaxClassRequest;
...
class TaxClassController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return travalorics_view('panel::tax_classes.index', $data);
    }
    ...
    public function form(TaxClass $taxClass): mixed
    {
        ...
        return travalorics_view('panel::tax_classes.form', $data);
    }
