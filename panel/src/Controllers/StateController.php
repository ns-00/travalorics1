...
use Throwable;
use Travalorics\Common\Models\State;
use Travalorics\Common\Repositories\StateRepo;
use Travalorics\Panel\Requests\StateRequest;
...
class StateController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return travalorics_view('panel::states.index', $data);
    }
    ...
    public function form(State $state): mixed
    {
        ...
        return travalorics_view('panel::states.form', $data);
    }
