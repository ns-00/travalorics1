...
use Travalorics\Common\Repositories\RoleRepo;
use Travalorics\Panel\Repositories\RouteRepo;
...
class RoleController extends BaseController
{
    ...
    public function index(): mixed
    {
        ...
        return travalorics_view('panel::roles.index', $data);
    }
    ...
    public function form(Role $role): mixed
    {
        ...
        return travalorics_view('panel::roles.form', $data);
    }
