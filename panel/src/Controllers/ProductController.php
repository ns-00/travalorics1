...
use Travalorics\Common\Repositories\TaxClassRepo;
use Travalorics\Common\Repositories\WeightClassRepo;
use Travalorics\Common\Resources\SkuListItem;
use Travalorics\Panel\Requests\ProductRequest;
use Travalorics\Panel\Resources\ProductNameResource;
...
class ProductController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return travalorics_view('panel::products.index', $data);
    }
    ...
    public function form($product): mixed
    {
        ...
        return travalorics_view('panel::products.form', $data);
    }
