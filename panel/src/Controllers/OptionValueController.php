...
use Travalorics\Common\Models\OptionValue;
use Travalorics\Common\Repositories\OptionRepo;
use Travalorics\Common\Repositories\OptionValueRepo;
use Travalorics\Panel\Requests\OptionValueRequest;
...
class OptionValueController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return travalorics_view('panel::option_values.index', $data);
    }
