...
use Travalorics\Panel\Requests\TransactionRequest;
...
class TransactionController extends BaseController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return travalorics_view('panel::transactions.index', $data);
    }
    ...
    public function form(Transaction $transaction): mixed
    {
        ...
        return travalorics_view('panel::transactions.form', $data);
    }
    ...
    public function show(Transaction $transaction): mixed
    {
        ...
        return travalorics_view('panel::transactions.show', $data);
    }
