        ...
        <!-- API Configuration Section -->
            <div class="row mt-4">
              <div class="col-12">
                ...
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title mb-0">Google Gemini</h6>
                    <x-common-form-model-switch name="gemini_enabled" 
                                               :value="old('gemini_enabled', system_setting('gemini_enabled', false))" 
                                               id="gemini_enabled" />
                  </div>
                  <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('panel/setting.gemini_description') }} <a href="https://aistudio.google.com/app/apikey" target="_blank">{{ __('panel/setting.get_api_key') }}</a></p>
                    <div class="mb-3">
                      <x-common-form-input title="{{ __('panel/setting.gemini_api_key') }}" 
                                         name="gemini_api_key" 
                                         value="{{ old('gemini_api_key', system_setting('gemini_api_key')) }}"
                                         placeholder="..." />
                    </div>
                  </div>
                </div>
