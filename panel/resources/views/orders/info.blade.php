...
@section('content')
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      @hookupdate('panel.orders.info.order_items')
        <div class="table-responsive"><table class="table products-table align-middle">
          <thead>
            <tr>
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive"><table class="table table-response align-middle table-bordered" id="logisticsTable">
        <thead>
          <tr>
            <td>ID</td>
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive"><table class="table table-response align-middle">
        <thead>
          <tr>
