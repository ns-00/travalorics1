...
use Travalorics\Panel\Middleware\SetPanelLocale;
use Travalorics\Plugin\Core\PluginManager;
...
class PluginServiceProvider extends ServiceProvider
{
    ...
    {
        $this->loadViewsFrom(travalorics_path('plugin/resources/views'), 'plugin');
    }
    ...
    private function registerBladeInsertDirectives(): void
    {
        Blade::directive('hookinsert', function ($parameter) {
            ...
            return ' <?php
                ...
                '.$definedVars.'
                $output = \Travalorics\Plugin\Core\Blade\Hook::getSingleton()->getHook("'.$name.'",["data"=>$__definedVars],function($data) { return null; });
                if ($output)
                echo $output;
                ?>';
        });
    ...
    private function registerBladeUpdateDirectives(): void
    {
        ...
        Blade::directive('endhookupdate', function () {
            return ' <?php
                ...
                $output = \Travalorics\Plugin\Core\Blade\Hook::getSingleton()->getWrapper("$__hook_name",["data"=>$__definedVars],function($data) { return null; },$__hook_content);
                unset($__hook_name);
