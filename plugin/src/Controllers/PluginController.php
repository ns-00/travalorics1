...
use Travalorics\Plugin\Repositories\SettingRepo;
use Travalorics\Plugin\Resources\PluginResource;
use Travalorics\Plugin\Services\PluginService;
...
class PluginController
{
    ...
    public function index(Request $request): mixed
    {
        ...
        return travalorics_view('plugin::plugins.index', $data);
    }
    ...
    public function edit($code): View
    {
        try {
            ...
            return travalorics_view($view, $data);
        } catch (Exception $e) {
            ...
            return travalorics_view('plugin::plugins.error', $data);
        }
    }
