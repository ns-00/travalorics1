...
namespace Travalorics\Install\Libraries;

use Illuminate\Support\Facades\Artisan;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Hash;
use Illuminate\Support\Str;
use Travalorics\Install\Libraries\Database\MySQLDatabase;
use Travalorics\Install\Libraries\Database\SQLiteDatabase;
use Travalorics\Install\Libraries\Environment\EnvironmentChecker;

/**
 * Installer class
 *
 * Handles the installation process of Travalorics
 */
class Installer
{
    ...
    private function validateData(array $data): array
    {
        ...
        if ($data['db_type'] === 'mysql') {
            $required = ['db_hostname', 'db_port', 'db_name', 'db_username'];
    ...
    {
        $env = [
            'APP_NAME'  => $data['app_name'] ?? 'Travalorics',
            'APP_ENV'   => 'production',
