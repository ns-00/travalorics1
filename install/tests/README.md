# Travalorics Installer Tests

This directory contains test cases for the Travalorics installer.
...
```bash
php artisan test travalorics/install/tests
```

### Run Specific Test File

```bash
php artisan test travalorics/install/tests/InstallerTest.php
```

### Run Specific Test Method

```bash
php artisan test --filter test_can_install_with_my_sql travalorics/install/tests/InstallerTest.php
```
