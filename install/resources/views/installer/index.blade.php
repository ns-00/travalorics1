            ...
            <div class="row gx-2">
              ...
              <div class="col-6 mysql-item">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="database" name="db_name" required value="Travalorics"
                ...
                <div class="col-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="admin_email" name="admin_email" required
                           placeholder="{{ __('install/common.admin_account') }}" value="admin@Travalorics.com">
