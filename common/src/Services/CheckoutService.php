...
use Travalorics\Common\Repositories\CheckoutRepo;
use Travalorics\Common\Repositories\Order\FeeRepo;
use Travalorics\Common\Repositories\Order\HistoryRepo;
...
use Travalorics\Common\Resources\CheckoutSimple;
use Travalorics\Common\Services\Checkout\BillingService;
use Travalorics\Common\Services\Checkout\FeeService;
use Travalorics\Common\Services\Checkout\ShippingService;
...
class CheckoutService
{
    ...
    public function getShippingAddress(): array
    {
        ...
        if (! isset($data['country_code'])) {
            $data['country_code'] = $address->country->code ?? 'ET';
        }
