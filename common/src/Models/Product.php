...
use Travalorics\Common\Models\Product\Relation;
use Travalorics\Common\Models\Product\Sku;
use Travalorics\Common\Traits\HasPackageFactory;
use Travalorics\Common\Traits\Replicate;
...
class Product extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'spu_code', 'active', 'weight', 'weight_class', 'sales', 'viewed', 'seo_rating', 'seo_reviews',
    ];
    ...
    {
        return $this->hasMany(\Travalorics\Common\Models\Product\Attribute::class, 'product_id');
    }
    ...
    {
        return $this->hasMany(\Travalorics\Common\Models\Customer\Favorite::class, 'product_id', 'id');
    }
    ...
    {
        return $this->hasMany(\Travalorics\Common\Models\Product\Option::class, 'product_id', 'id');
    }
    ...
    {
        return $this->hasMany(\Travalorics\Common\Models\Product\OptionValue::class, 'product_id', 'id');
    }
    ...
    /**
     * Get actual sales count based on paid order items
     *
     * @return int
     */
    public function getActualSalesAttribute(): int
    {
        return (int) $this->orderItems()
            ->join('orders', 'order_items.order_id', '=', 'orders.id')
            ->whereNotIn('orders.status', ['cancelled', 'failed', 'declined'])
