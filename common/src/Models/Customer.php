...
use Throwable;
use Travalorics\Common\Models\Customer\Group;
use Travalorics\Common\Models\Customer\Social;
use Travalorics\Common\Models\Customer\Transaction;
use Travalorics\Common\Notifications\ForgottenNotification;
use Travalorics\Common\Notifications\RegistrationNotification;
...
class Customer extends AuthUser
{
    ...
    {
        return $this->hasMany(\Travalorics\Common\Models\Customer\Favorite::class, 'customer_id');
    }
