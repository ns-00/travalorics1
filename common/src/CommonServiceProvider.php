...
namespace Travalorics\Common;

use Illuminate\Support\Facades\Config;
use Illuminate\Support\ServiceProvider;
use Travalorics\Common\Components\Base;
use Travalorics\Common\Components\Forms;
use Travalorics\Common\Console\Commands;
...
class CommonServiceProvider extends ServiceProvider
{
    ...
    {
        $this->mergeConfigFrom($this->basePath.'config/travalorics.php', 'travalorics');
        if (installed()) {
    ...
    {
        $originViewPath = travalorics_path('common/resources/views');
