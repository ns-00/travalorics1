...
use Throwable;
use Travalorics\Common\Models\Currency;
...
class SettingRepo extends BaseRepo
{
    ...
    private function clearConfigCache(): void
    {
        ...
        // Reload settings for the current request
        config(['travalorics' => array_merge((array) config('travalorics', []), $this->groupedSettings())]);
    }
}
