...
use Travalorics\Common\Models\Product\OptionValue;
...
class OptionValueRepo extends BaseRepo
{
    ...
    public function createProductOptionValues(int $productId, $optionValues): bool
    {
        ...
        \Travalorics\Common\Models\Product\Option::where('product_id', $productId)->delete();
        ...
        foreach ($optionValues as $optionConfig) {
            ...
            \Travalorics\Common\Models\Product\Option::create([
