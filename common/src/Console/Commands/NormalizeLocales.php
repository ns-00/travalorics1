...
use Travalorics\Common\Models\Setting;

/**
 * Locale normalization command
 *
 * This command requires Travalorics version >= 0.4.0
 */
class NormalizeLocales extends Command
{
    ...
    public function handle(): void
    {
        ...
        $currentVersion = config('Travalorics.version');
        if (version_compare($currentVersion, '0.4.0', '<')) {
            $this->error('This command requires Travalorics version 0.4.0 or higher.');
