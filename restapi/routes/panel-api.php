...
use Travalorics\RestAPI\PanelApiControllers;
...
Route::middleware($middlewares)->group(function () {
    ...
    Route::get('/file_manager/storage_config', [\Travalorics\RestAPI\PanelApiControllers\FileManagerController::class, 'getStorageConfig']);
    Route::post('/file_manager/storage_config', [\Travalorics\RestAPI\PanelApiControllers\FileManagerController::class, 'saveStorageConfig']);
});
