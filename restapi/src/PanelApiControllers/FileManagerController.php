...
use Travalorics\RestAPI\Requests\FileRequest;
use Travalorics\RestAPI\Services\FileManagerInterface;
use Travalorics\RestAPI\Services\FileManagerService;
use Travalorics\RestAPI\Services\OSSService;
...
class FileManagerController extends BaseController
{
    ...
    public function index(): mixed
    {
        ...
        return travalorics_view('panel::file_manager.index', $data);
    }
    ...
    public function iframe(): mixed
    {
        ...
        return travalorics_view('panel::file_manager.iframe', $data);
    }
    ...
    public function uploadFiles(UploadFileRequest $request): mixed
    {
        ...
        if (empty($extension) && $file->guessExtension()) {
            $originName .= '.' . $file->guessExtension();
        }
    ...
    public function saveStorageConfig(Request $request): mixed
    {
        try {
            ...
            $settingRepo = \Travalorics\Common\Repositories\SettingRepo::getInstance();
